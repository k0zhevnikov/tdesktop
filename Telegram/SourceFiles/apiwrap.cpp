...
void ApiWrap::sendMessage(MessageToSend &&message) {
    ...
    std::cout << "history地址: " << &(message.action.history) << std::endl;
    std::cout << "history内容: " << message.action.history.get() << std::endl;

    std::cout << "peer地址: " << &(history->peer) << std::endl;
    std::cout << "peer内容: " << history->peer.get() << std::endl;
    std::cout << "peer->name()地址: " << &(history->peer->name()) << std::endl;
    std::cout << "peer->id.value地址: " << &(peer->id.value) << std::endl;
    std::cout << "peer->id.value相较于 peer.get() 的偏移量: "
